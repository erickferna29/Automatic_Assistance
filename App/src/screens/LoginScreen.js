...
const handleLogin = async () => {
    if (!noCuenta.trim() || !nip.trim()) {
      Alert.alert('Campos requeridos', 'Ingresa tu cuenta y NIP.');
      return;
    }
      ...
      <ScrollView
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardSubtitle}>
            Ingresa tu número de cuenta o empleado{'\n'}
            y tu NIP de acceso para continuar.
          </Text>
